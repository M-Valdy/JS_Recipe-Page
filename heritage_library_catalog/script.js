...
// parse a card of books to validate
...
// parse all the cards in the catalog
...
// example usage: find all books by Stephen King
...
// example usage: find all books from 2002
...
// shows each book entry in a nice format
...
// makes sure all the required fields are present and not "Unknown"
...
// export the catalog in JSON format
function exportToJSON(catalog) {
  return JSON.stringify(catalog, null, 2);
}

// export the catalog in CSV format
