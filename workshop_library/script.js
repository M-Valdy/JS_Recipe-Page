...
function getBookSummaries(catalog) {
  // This function takes a catalog of books and returns a string containing the summaries of each book, 
...
// Displaying the list of books by a specific author
console.log("\nList of books by Arvid Kahl:\n");

function getBooksByAuthor(catalog, author) {
  // This function takes a catalog of books and an author's name, 
...
// Displaying the total number of pages for all books in the library
console.log("\nTotal number of pages for all library books:\n");

function getTotalPages(books) {
  // This function takes an array of books and returns the total number of pages for all books in the array.
